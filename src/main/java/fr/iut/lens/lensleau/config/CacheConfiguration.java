package fr.iut.lens.lensleau.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(fr.iut.lens.lensleau.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(fr.iut.lens.lensleau.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
